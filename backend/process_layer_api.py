...
def process_layer_model(t, y, kf1, kr1, kf2, kr2):
    # 这里可根据实际处理层模型修改，暂复用传感层ODE
    P, A, Dop, PA, A_Dop = y
...
@app.route('/api/process-layer', methods=['POST'])
def process_layer():
    ...
    try:
        ...
        plt.title('Process Layer: Active DNA Template vs. Time')
